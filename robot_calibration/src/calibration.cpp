...
struct CostFunctor
{
  ...
  // templated operator to calculate residual, which is squared norm of the difference between the true ee position and the ee position calculated with theta + offset
  template <typename T>
...
{
  YAML::Node yaml_node = YAML::LoadFile("/home/jad/catkin_ws/src/Robot-Calibration-Deep-Dives-DP/robot_calibration/"
                                        "sensor_data/fake_testing.yaml");
